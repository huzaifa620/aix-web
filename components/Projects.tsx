...
const projects: Project[] = [
  ...
  {
    logo: '/static/images/client10-logo.png',
    cover: '/static/images/agentarc.png',
    companyName: 'Agent Arc',
    website: 'https://beta.agentarc.ai/',
    companyType: 'AI Trading Platform',
    details:
      'Powered by neural networks and LLMs, it analyzes markets 24/7, executes trades on your account.',
  },
  // {
